package org.flixel
{
	...
	public class FlxU
	{
		...
		/**
		 *  Check if mouse overlaps Sprite
		 * @param	sprite - for check
		 * @return true - if overlap
		 */
		static public function inSprite(sprite:FlxSprite):Boolean
		{
			if (FlxG.mouse.x >= sprite.x 
			&& FlxG.mouse.x <= sprite.x + sprite.width 
			&& FlxG.mouse.y >= sprite.y
			&& FlxG.mouse.y <= sprite.y + sprite.height)
				return true;
			return false;
		}
	}
